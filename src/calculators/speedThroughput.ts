export type SpeedMode = "toSpeed" | "toThroughput";
export type ThroughputUnit = "min" | "hr";

export interface SpeedThroughputInput {
  mode: SpeedMode;
  throughput: string;
...
export interface SpeedThroughputResult {
  value: string;
  unit: string;
  label: string;
  extra: string;
...
export function calcSpeedThroughput({
  mode,
  throughput,
  throughputUnit,
  parcelLength,
  gap,
  speed,
}: SpeedThroughputInput): SpeedThroughputResult | null {
