...
function VarRow({ symbol, desc }: Variable) {
  return (
...
function ReferenceCard({ title, formulas, variables, notes }: ReferenceCardProps) {
  return (
...
export function ReferenceScreen({ setView }: ScreenProps) {
  return (
    <div>
